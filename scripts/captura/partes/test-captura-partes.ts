...
import { getTribunalConfig, autenticarPJE, capturarPartesProcesso, getCredentialByTribunalAndGrau, type ProcessoParaCaptura } from '@/app/(authenticated)/captura/server';
