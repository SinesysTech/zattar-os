...
import { autenticarPJE, getTribunalConfig, fetchPJEAPI, getCredentialByTribunalAndGrau, type AuthResult } from '@/app/(authenticated)/captura/server';
...
async function main() {
  ...
  try {
    ...
    const ADVOGADO_ID = 1; // ID do advogado na tabela
