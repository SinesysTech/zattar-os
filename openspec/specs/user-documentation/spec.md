...
- **THEN** o sistema exibe a página inicial da documentação com uma descrição geral do ZattarOS, cards de acesso rápido para cada categoria de módulos (Principal, Serviços, Gestão), e um campo de busca no topo
