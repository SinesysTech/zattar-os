# formsign-signature Specification

## Purpose
TBD - created by archiving change add-formsign-signature-service. Update Purpose after archive.
## Requirements
...
- **THEN** o sistema gera o PDF final, salva assinatura/foto em storage, grava registro em formsign_assinaturas e retorna protocolo e pdf_url
...
- **THEN** o sistema retorna as sessões de formsign_sessoes_assinatura com paginação e total

### Requirement: Proteção por autorização administrativa
O sistema SHALL restringir acesso aos endpoints de assinatura/preview e listagem de sessões/assinaturas a usuários com permissão formsign_admin.

#### Scenario: Acesso autorizado
- **WHEN** um usuário autenticado com permissão formsign_admin acessa as rotas
