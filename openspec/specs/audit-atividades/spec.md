# audit-atividades Specification

## Purpose
Consulta e exibição de logs de atividades de negócio a partir da tabela `logs_alteracao`, com repository de consulta paginada, server action com controle de permissão, e mapeamento de eventos para exibição humanizada.
