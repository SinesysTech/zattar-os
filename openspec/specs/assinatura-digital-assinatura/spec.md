# assinatura-digital-assinatura Specification

## Purpose

Fluxo de assinatura digital: preview de PDF, finalização de assinatura com registro de metadados de segurança, gestão de sessões e integração com sistema externo.
