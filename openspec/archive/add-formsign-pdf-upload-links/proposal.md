...
- Affected specs:
  - `assinatura-digital-admin` (novo fluxo de criação e gestão de documentos/links)
  - `assinatura-digital-assinatura` (novo fluxo público do assinante e regras de finalização)
