# Change: Integrar AdminService do Formsign ao backend Sinesis

## Why
Integrar a gestao administrativa do Formsign (dash de assinaturas, CRUD de formularios/templates/segmentos) ao app principal para centralizar a plataforma de assinatura digital.
