...
**Then** a página deve ter Title "Processo [número] - [Autora] vs [Ré] | ZattarOS" e Description "Processo trabalhista [número] no [TRT] - [Classe Judicial]"

#### Scenario: Metadata de fallback
**Given** processo não foi carregado ainda (erro)
**Then** usar metadata padrão Title "Processo | ZattarOS" e Description "Visualização de processo no ZattarOS"
