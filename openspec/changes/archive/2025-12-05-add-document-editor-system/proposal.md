...
O ZattarOS atualmente não possui um sistema standalone para criação, edição e gerenciamento de documentos internos. Usuários precisam recorrer a ferramentas externas (Google Docs, Word) para criar documentos de trabalho, petições, atas, minutas e outros textos do dia a dia do escritório.
