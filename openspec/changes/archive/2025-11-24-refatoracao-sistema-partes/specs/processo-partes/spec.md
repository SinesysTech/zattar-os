...
- **Depends on**: `database-partes` (tabela processo_partes criada)
- **Depends on**: `acervo` (tabela de processos)
- **Related**: `clientes`, `partes-contrarias`, `terceiros` (entidades vinculadas)
