...
- **Depends on**: `database-partes` (tabela terceiros criada)
- **Related**: `processo-partes` (relacionamento com processos)
- **Related**: `enderecos` (endereços de terceiros)
