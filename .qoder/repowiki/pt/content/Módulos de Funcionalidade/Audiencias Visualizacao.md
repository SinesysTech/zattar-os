...
- Célula editável com textarea e botões de salvar/cancelar.
...
- Células editáveis:
  ...
  - Observações: textarea com salvamento automático.
...
- Observações: edite diretamente no campo de observações e confirme com o botão de salvar.
