...
export function ExpedienteDetalhesDialog({
  ...
  const PrazoEditor: React.FC<{ exp: Expediente; onUpdated: (u: Expediente) => void }> = ({ exp, onUpdated }) => {
              ...
              <div className="border-t pt-4 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-muted/10 p-3 rounded-md border">
                    <div className="text-sm text-muted-foreground mb-1">Data de Ciência</div>
                    <div className="font-medium">{formatarData(expedienteUnico.dataCienciaParte)}</div>
                  </div>
                  <div className="bg-muted/10 p-3 rounded-md border">
                    <div className="text-sm text-muted-foreground mb-1">Prazo Legal</div>
