...
/**
 * CHAT FEATURE - RoomList Component
 *
 * Lista de salas de chat com ícones por tipo.
 */
...
interface RoomListProps {
  ...
  /** Callback ao selecionar uma sala */
  onSelectSala: (sala: SalaChat) => void;
}

/**
 * Lista de salas de chat com ícones indicando o tipo.
 */
