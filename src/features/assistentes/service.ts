...
export async function criarAssistente(data: unknown, usuarioId: number): Promise<Assistente> {
  // 1. Validar entrada
...
export async function atualizarAssistente(id: number, data: unknown): Promise<Assistente> {
