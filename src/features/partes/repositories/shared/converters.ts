 ...
 */
export function converterParaParteContraria(data: Record<string, unknown>): ParteContraria {
  const tipo_pessoa = data.tipo_pessoa as TipoPessoa;
 ...
 */
export function converterParaEndereco(data: Record<string, unknown> | null): Endereco | null {
  if (!data) return null;
...
export type { Endereco } from '@/features/enderecos';
