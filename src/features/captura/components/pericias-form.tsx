...
import { capturarPericias } from '@/features/captura/services/api-client';
import { SITUACAO_PERICIA_OPTIONS } from '@/features/captura/constants';
...
export function PericiasForm({ onSuccess }: PericiasFormProps) {
