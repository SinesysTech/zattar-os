...
import { ModalidadeAudiencia, MODALIDADE_AUDIENCIA_LABELS } from '@/core/audiencias/domain';
...
export function AudienciaModalidadeBadge({
  ...
  switch (modalidade) {
    ...
    case ModalidadeAudiencia.Hibrida:
      ...
      colorClass =
        'bg-teal-100 text-teal-800 hover:bg-teal-200 dark:bg-teal-900 dark:text-teal-100 dark:hover:bg-teal-800';
      break;
    default:
      Icon = null;
      break;
