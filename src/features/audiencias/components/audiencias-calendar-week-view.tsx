...
/**
 * AudienciasCalendarWeekView - Visualização semanal de audiências
 *
 * Exibe audiências em um grid de 7 dias com slots de hora.
 * O carrossel de navegação de dias é gerenciado pelo componente parent (AudienciasContent).
 */
