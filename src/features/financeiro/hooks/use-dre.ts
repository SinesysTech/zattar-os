...
export const useDRE = (params: UseDREParams): UseDREResult => {
    ...
    const buscarDRE = useCallback(async () => {
        ...
        try {
            ...
            setComparativo(result.data.comparativo || null);
        } catch (err) {
...
export const useExportarDRE = (): UseExportarDREResult => {
    ...
    const exportarPDF = useCallback(async (
        ...
        try {
            const result = await actionExportarDREPDF({ dataInicio, dataFim, tipo });
    ...
    const exportarCSV = useCallback(async (
        ...
        try {
            const result = await actionExportarDRECSV({ dataInicio, dataFim, tipo });
