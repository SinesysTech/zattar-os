...
export function parseUsuariosFilters(selectedFilters: string[]): ListarUsuariosParams {
  return parseFilterValues(selectedFilters, USUARIOS_FILTER_CONFIGS) as ListarUsuariosParams;
}
