...
interface RepresentanteContatoSectionProps {
...
export function RepresentanteContatoSection({ data }: RepresentanteContatoSectionProps) {
  ...
  // Also check for single email field
  const singleEmail = data.email as string | null;
  if (singleEmail && !emails.includes(singleEmail)) {
