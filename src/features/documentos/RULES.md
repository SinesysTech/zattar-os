...
## Contexto
Módulo para gestão de documentos digitais vinculados a processos e clientes. Gerencia upload, versionamento, compartilhamento, categorização e organização em pastas. Integra-se com Supabase Storage e sistema de assinatura digital.

## Entidades Principais
- **Documento**: Arquivo digital com metadados
- **Pasta**: Organização hierárquica de documentos
- **VersaoDocumento**: Histórico de versões de um documento
- **Compartilhamento**: Registro de compartilhamento externo
