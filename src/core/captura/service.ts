/**
 * CAPTURA SERVICE - Orquestrador Genérico
 *
 * Service que usa a Factory e chama o driver de forma polimórfica.
 * Não conhece detalhes de implementação específicos (PJE, ESAJ, etc).
 */
...
/**
 * Executa uma captura de processos/audiências
 *
 * Fluxo:
