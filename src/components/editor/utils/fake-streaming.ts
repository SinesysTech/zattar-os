...
import { markdownChunks, mdxChunks } from '../constants';

import { createCommentChunks } from './chunk-generators';

export type FakeStreamTextOptions = {
  editor: PlateEditor;
  chunkCount?: number;
...
/**
 * Creates a fake streaming response for testing purposes.
 * Used to simulate AI responses when the real API is not available.
 */
