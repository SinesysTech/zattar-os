...
import { commentPlugin } from '@/components/editor/plate/comment-kit';
import {
  type TDiscussion,
  discussionPlugin,
} from '@/components/editor/plate/discussion-kit';
import { suggestionPlugin } from '@/components/editor/plate/suggestion-kit';
