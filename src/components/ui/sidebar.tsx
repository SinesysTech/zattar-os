...
function Sidebar({
  ...
  return (
    <div
      ...
      {/* Design System Exception: sidebar width transition kept for layout reflow.
          transform alternatives would require fixed positioning and overlay approach. */}
      <div
      ...
      />
      {/* Design System Exception: sidebar left/right/width transitions kept for layout reflow.
          transform alternatives would require fixed positioning and overlay approach. */}
      <div
        data-slot="sidebar-container"
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh min-h-svh w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
const sidebarMenuButtonVariants = cva(
  // Design System Exception: menu button width/height/padding transitions kept for sidebar collapse animation.
...
function SidebarMenuSkeleton({
  ...
  // Using useState with lazy initialization to avoid calling Math.random during render
