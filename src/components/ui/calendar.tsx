...
function Nav({
  ...
  }, [previousMonth, goToMonth, navView, displayYears.from, displayYears.to, setDisplayYears, onPrevClick]);
  ...
  }, [goToMonth, nextMonth, navView, displayYears.from, displayYears.to, setDisplayYears, onNextClick]);
  return (
