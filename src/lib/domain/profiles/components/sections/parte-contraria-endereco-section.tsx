...
import { CopyButton, MapButton } from "@/app/(authenticated)/partes";

interface ParteContrariaEnderecoSectionProps {
...
export function ParteContrariaEnderecoSection({ data }: ParteContrariaEnderecoSectionProps) {
