  ...
  sidebarSections: [
      ...
      fields: [
        {
          ...
          valuePath: "data_nascimento_formatada",
          icon: Calendar,
        },
        ...
        {
          label: "Naturalidade",
          valuePath: "naturalidade_completa",
          icon: MapPin,
        },
        {
          label: "País Nascimento",
          valuePath: "pais_nascimento_descricao",
          icon: Globe,
        },
        {
          label: "Escolaridade",
          valuePath: "escolaridade_codigo",
          icon: GraduationCap,
        },
        {
          label: "Situação CPF",
          valuePath: "situacao_cpf_receita_descricao",
          icon: BadgeCheck,
        },
        {
          label: "Pode receber SMS",
          valuePath: "pode_usar_celular_mensagem_label",
          icon: MessageSquare,
          type: "text",
        },
      ],
    },
    {
      ...
      fields: [
        {
          label: "Data Abertura",
          valuePath: "data_abertura_formatada",
          icon: Calendar,
        },
        {
          label: "Fim Atividade",
          valuePath: "data_fim_atividade_formatada",
          icon: Calendar,
        },
        {
          label: "Ramo Atividade",
          valuePath: "ramo_atividade",
          icon: Briefcase,
        },
        { label: "Porte", valuePath: "porte_descricao", icon: Building2 },
        {
          label: "Órgão Público",
          valuePath: "orgao_publico_label",
          icon: Building2,
          type: "text",
        },
        {
          label: "Situação CNPJ",
          valuePath: "situacao_cnpj_receita_descricao",
          icon: BadgeCheck,
        },
        {
          label: "CPF Responsável",
          valuePath: "cpf_responsavel_formatado",
          icon: User,
        },
      ],
    },
    {
      ...
      fields: [
        ...
        {
          label: "Residencial",
          valuePath: "residencial_formatado",
          icon: Phone,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        {
          label: "Complemento",
          valuePath: "endereco.complemento",
          icon: MapPin,
        },
