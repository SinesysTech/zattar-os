  ...
  public: {
    Tables: {
      ...
      assinatura_digital_documentos: {
        ...
        Relationships: [
          {
            foreignKeyName: "assinatura_digital_documentos_contexto_parcela_id_fkey"
            columns: ["contexto_parcela_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "assinatura_digital_documentos_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "assinatura_digital_templates"
            referencedColumns: ["id"]
          },
        ]
      }
      ...
      assinatura_digital_pacote_documentos: {
        ...
        Relationships: [
          {
            foreignKeyName: "assinatura_digital_pacote_documentos_documento_id_fkey"
            columns: ["documento_id"]
            isOneToOne: false
            referencedRelation: "assinatura_digital_documentos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "assinatura_digital_pacote_documentos_pacote_id_fkey"
            columns: ["pacote_id"]
            isOneToOne: false
            referencedRelation: "assinatura_digital_pacotes"
            referencedColumns: ["id"]
          },
        ]
      }
      assinatura_digital_pacotes: {
        ...
        Relationships: [
          {
            foreignKeyName: "assinatura_digital_pacotes_contrato_id_fkey"
            columns: ["contrato_id"]
            isOneToOne: false
            referencedRelation: "contratos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "assinatura_digital_pacotes_criado_por_fkey"
            columns: ["criado_por"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "assinatura_digital_pacotes_formulario_id_fkey"
            columns: ["formulario_id"]
            isOneToOne: false
            referencedRelation: "assinatura_digital_formularios"
            referencedColumns: ["id"]
      ...
      audiencias: {
        Row: {
          ...
          endereco_editado_manualmente: boolean
          ...
          url_editada_manualmente: boolean
        }
        Insert: {
          advogado_id: number
          ata_audiencia_id?: number | null
      ...
      comunica_cnj_resumos: {
        ...
        Relationships: [
          {
            foreignKeyName: "comunica_cnj_resumos_comunicacao_id_fkey"
            columns: ["comunicacao_id"]
            isOneToOne: true
            referencedRelation: "comunica_cnj"
            referencedColumns: ["id"]
          },
        ]
      }
      comunica_cnj_sync_log: {
        Row: {
          created_at: string
          duplicados: number
        ...
        Relationships: [
          {
            foreignKeyName: "comunica_cnj_sync_log_executado_por_fkey"
      ...
      comunica_cnj_views: {
        ...
        Relationships: [
          {
            foreignKeyName: "comunica_cnj_views_criado_por_fkey"
            columns: ["criado_por"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
      ...
      dados_bancarios_cliente: {
        ...
        Relationships: [
          {
            foreignKeyName: "dados_bancarios_cliente_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["id"]
      ...
      entrevista_anexos: {
        ...
        Relationships: [
          {
            foreignKeyName: "entrevista_anexos_entrevista_id_fkey"
            columns: ["entrevista_id"]
            isOneToOne: false
            referencedRelation: "entrevistas_trabalhistas"
            referencedColumns: ["id"]
          },
        ]
      }
      entrevistas_trabalhistas: {
        Row: {
          contrato_id: number
          created_at: string
          created_by: number | null
          ...
          notas_operador: Json | null
          perfil_reclamante: string | null
          respostas: Json
          status: Database["public"]["Enums"]["status_entrevista"]
          testemunhas_mapeadas: boolean
          tipo_litigio: Database["public"]["Enums"]["tipo_litigio_trabalhista"]
          updated_at: string
        }
        Insert: {
          contrato_id: number
        ...
        Relationships: [
          {
            foreignKeyName: "entrevistas_trabalhistas_contrato_id_fkey"
            columns: ["contrato_id"]
            isOneToOne: true
            referencedRelation: "contratos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "entrevistas_trabalhistas_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
      ...
      expedientes: {
        Row: {
          ...
          responsavel_id: number | null
          resultado_decisao:
            | Database["public"]["Enums"]["resultado_decisao_enum"]
            | null
          segredo_justica: boolean
      ...
      parcelas: {
        Row: {
          ...
          created_at: string | null
          dados_bancarios_snapshot: Json | null
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "parcelas_documento_assinatura_id_fkey"
      ...
      partes_contrarias_transitorias: {
        Row: {
        ...
        Relationships: [
          {
            foreignKeyName: "partes_contrarias_transitorias_criado_em_contrato_id_fkey"
            columns: ["criado_em_contrato_id"]
            isOneToOne: false
            referencedRelation: "contratos"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "partes_contrarias_transitorias_criado_por_fkey"
            columns: ["criado_por"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "partes_contrarias_transitorias_promovido_para_id_fkey"
            columns: ["promovido_para_id"]
            isOneToOne: false
            referencedRelation: "partes_contrarias"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "partes_contrarias_transitorias_promovido_por_fkey"
      ...
      public_leads: {
        ...
        Relationships: [
          {
            foreignKeyName: "public_leads_atribuido_a_fkey"
            columns: ["atribuido_a"]
            isOneToOne: false
            referencedRelation: "usuarios"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "public_leads_cliente_id_fkey"
            columns: ["cliente_id"]
            isOneToOne: false
            referencedRelation: "clientes"
            referencedColumns: ["id"]
    ...
    Views: {
      ...
      audiencias_com_origem: {
        Row: {
          ...
          endereco_editado_manualmente: boolean | null
          endereco_presencial: Json | null
          grau: Database["public"]["Enums"]["grau_tribunal"] | null
          hora_fim: string | null
          hora_inicio: string | null
          ...
          juizo_digital: boolean | null
          modalidade: Database["public"]["Enums"]["modalidade_audiencia"] | null
          modalidade_editada_manualmente: boolean | null
          numero_processo: string | null
          observacoes: string | null
          orgao_julgador_id: number | null
          orgao_julgador_origem: string | null
          ...
          url_ata_audiencia: string | null
          url_audiencia_virtual: string | null
          url_editada_manualmente: boolean | null
        }
        Relationships: [
          {
            foreignKeyName: "audiencias_advogado_id_fkey"
      ...
      vw_queries_mais_frequentes: {
        Row: {
          calls: number | null
          query_resumida: string | null
          queryid: number | null
          rows: number | null
      ...
      vw_queries_mais_lentas: {
        Row: {
          calls: number | null
          percentual_tempo: number | null
          query_resumida: string | null
          queryid: number | null
          rows: number | null
          tempo_maximo_ms: number | null
          tempo_medio_ms: number | null
          tempo_minimo_ms: number | null
          tempo_total_ms: number | null
        }
        Relationships: []
      }
    ...
    Functions: {
      ...
      promote_parte_contraria_transitoria: {
        Args: {
          p_parte_contraria_id: number
          p_promovido_por: number
          p_transitoria_id: number
        }
        Returns: Json
      }
    ...
    Enums: {
      ...
      status_contrato:
        ...
        | "distribuido"
        | "desistencia"
      status_entrevista: "rascunho" | "em_andamento" | "concluida"
