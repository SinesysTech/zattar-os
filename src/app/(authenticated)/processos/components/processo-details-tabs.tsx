      ...
      <CollapsibleContent>
        <Tabs defaultValue="expedientes">
          ...
          {isLoading ? (
            ...
            <>
              <TabsContent value="expedientes" className={cn("mt-0 rounded-xl border bg-background/70 inset-medium")}>
              ...
              <TabsContent value="audiencias" className={cn("mt-0 rounded-xl border bg-background/70 inset-medium")}>
                <div className={cn("max-h-96 overflow-y-auto pr-1")}>
                  <AudienciasTable audiencias={audiencias} />
                </div>
              </TabsContent>
              <TabsContent value="pericias" className={cn("mt-0 rounded-xl border bg-background/70 inset-medium")}>
                <div className={cn("max-h-96 overflow-y-auto pr-1")}>
