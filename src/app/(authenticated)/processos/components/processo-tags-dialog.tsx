    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <div className={cn("flex flex-col stack-default")}>
        ...
        <div>
          ...
          <div className={cn("mt-2 flex flex-wrap inline-tight min-h-10 inset-tight border rounded-md bg-muted/30")}>
        ...
        <div>
          ...
          {showNewTagForm && (
            <div className={cn("flex flex-col mb-3 inset-medium border rounded-md bg-muted/30 stack-medium")}>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <Button
                      type="button"
                      variant="outline"
                      className={cn("w-10 inset-none")}
                      style={{ backgroundColor: newTagCor }}
                    >
                      <span className="sr-only">Escolher cor</span>
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className={cn("w-auto inset-medium")}>
          ...
          {isLoading ? (
            ...
            <div className={cn("flex flex-wrap inline-tight max-h-48 overflow-y-auto inset-tight border rounded-md")}>
              {todasTags.length === 0 ? (
