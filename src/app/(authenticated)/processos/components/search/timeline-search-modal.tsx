...
export function TimelineSearchModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={cn("flex max-w-120 inset-none inline-none overflow-hidden")}>
        {/* Campo de busca */}
        <div
        ...
        >
          ...
          <input
            ...
            className={cn("flex-1 bg-transparent border-none text-body-lg placeholder:text-muted-foreground inset-none outline-none focus:ring-0")}
          />
        ...
        <div
          ref={resultsRef}
          className={cn("flex flex-col max-h-[70vh] overflow-y-auto inset-tight stack-micro")}
          role="listbox"
