    ...
    <div className="relative flex h-full flex-col bg-background">
      ...
      <div className="relative flex-1 overflow-hidden" ref={viewportRef}>
        ...
        {isLoading ? (
          ...
          <div className={cn("flex flex-col items-center justify-center h-full inline-medium inset-extra-loose text-center")}>
            ...
            <button
              ...
              className={cn(/* design-system-escape: gap-1.5 gap sem token DS; px-3 padding direcional sem Inset equiv.; py-1.5 padding direcional sem Inset equiv.; text-xs → migrar para <Text variant="caption">; */ /* design-system-escape: px-3 padding direcional sem Inset equiv.; py-1.5 padding direcional sem Inset equiv.; */ "inline-flex items-center inline-snug rounded-full border bg-card px-3 py-1.5 text-caption font-medium text-foreground transition-colors hover:bg-accent cursor-pointer")}
            >
