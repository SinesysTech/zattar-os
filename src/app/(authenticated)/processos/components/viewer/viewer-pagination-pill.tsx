...
export function ViewerPaginationPill({
  ...
  return (
    ...
    >
      <div className={cn("flex items-center h-10 px-2 inline-none rounded-full bg-card border shadow-sm")}>
        ...
        <button
          ...
          className={cn(
            'flex items-center justify-center inset-snug rounded-full transition-opacity',
        ...
        <input
          ...
          className={cn("w-8 text-center bg-transparent border-none inset-none text-body-sm font-mono focus:outline-none focus:ring-0")}
        />
