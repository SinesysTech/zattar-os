...
function ShadowScale() {
  ...
  return (
    <SpecimenCard eyebrow="SHADOW · ELEVAÇÃO">
      ...
      <div className={cn("flex items-center inline-tight-plus rounded-xl border border-destructive/30 bg-destructive/[0.08] px-3 py-2.5 text-[12px] text-destructive")}>
