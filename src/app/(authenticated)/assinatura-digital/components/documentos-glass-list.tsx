...
function GlassRow({
  ...
  return (
    <div
      ...
      className={cn(
        'w-full text-left rounded-2xl border inset-card-compact cursor-pointer backdrop-blur-md',
    ...
    >
      <div className={cn("grid grid-cols-[auto_1fr_auto_auto_auto_auto] inline-medium items-center")}>
        {/* Status dot */}
        <span
          aria-hidden="true"
        ...
        <span
          className={cn(
            /* design-system-escape: px-2 padding direcional sem Inset equiv.; py-1 padding direcional sem Inset equiv. */ 'flex hidden sm:inline-flex items-center inline-snug backdrop-blur-sm rounded-lg text-[10px] font-semibold tracking-[0.04em] px-2 py-1 border whitespace-nowrap',
            cfg.pill,
          )}
        >
          {cfg.label}
...
function GlassCard({
  ...
  return (
    <div
      ...
      className={cn(
        'relative flex flex-col inline-medium rounded-2xl border inset-card-compact cursor-pointer backdrop-blur-md',
        'transition-all duration-180 ease-out',
        'hover:border-border/70 hover:-translate-y-px hover:shadow-sm',
