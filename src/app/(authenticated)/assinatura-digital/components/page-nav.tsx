        ...
        {TABS.map(({ href, label, icon: Icon, match }) => {
          ...
          return (
            <Link
              ...
              className={cn(
                /* design-system-escape: gap-1.5 gap sem token DS; px-3 padding direcional sem Inset equiv.; py-1.5 padding direcional sem Inset equiv.; text-xs → migrar para <Text variant="caption">; */ /* design-system-escape: px-3 padding direcional sem Inset equiv.; py-1.5 padding direcional sem Inset equiv.; */ 'flex items-center inline-snug rounded-xl px-3 py-1.5 text-caption font-medium transition-colors',
                active
