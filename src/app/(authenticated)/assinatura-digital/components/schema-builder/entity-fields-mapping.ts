...
const PARTE_CONTRARIA_FIELDS: EntityFieldDefinition[] = [
  // Campo de busca (entitySearch.autoFill configurado aqui preenche o resto)
  { fieldName: 'busca_parte_contraria', label: 'Busca de Parte Contrária', type: FormFieldType.PARTE_CONTRARIA_SEARCH, icon: Search, description: 'Buscar parte contrária por nome, CPF ou CNPJ e preencher automaticamente', pessoaTipo: 'ambos', badge: 'Busca' },
