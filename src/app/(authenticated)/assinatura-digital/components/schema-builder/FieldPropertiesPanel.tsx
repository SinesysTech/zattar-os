...
import type { FormFieldSchema } from '@/shared/assinatura-digital/types/domain';
import { FormFieldType, fieldRequiresOptions } from '@/shared/assinatura-digital/types/domain';
          ...
          <ScrollArea className="flex-1">
            ...
            >
              ...
              <CollapsibleContent className={cn("flex flex-col pt-2 stack-medium")}>
                ...
                <FormField
                  ...
                  name="hidden"
                  render={({ field: formField }) => (
                    <FormItem className={cn("flex flex-row items-start space-x-3 stack-none")}>
                      <FormControl>
                        <Checkbox
            ...
            {availableFields.length > 0 && (
              <>
                ...
                >
                  <CollapsibleTrigger className={cn("flex items-center inline-tight w-full inset-tight rounded-md hover:bg-muted/50 transition-colors")}>
                ...
                >
                  ...
                  <CollapsibleContent className={cn("flex flex-col pt-2 stack-tight")}>
                    {options.map((option, index) => (
                      <div key={index} className={cn("flex items-start inline-tight inset-tight border rounded-lg")}>
