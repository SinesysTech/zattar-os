        ...
        <div className="relative flex h-full min-h-0 flex-1 flex-col overflow-hidden">
          ...
          {isSaving && (
            <div className="absolute top-4 right-6 z-20">
              <span className={cn(/* design-system-escape: gap-1.5 gap sem token DS; px-3 padding direcional sem Inset equiv.; py-1.5 padding direcional sem Inset equiv.; text-xs → migrar para <Text variant="caption">; font-medium → className de <Text>/<Heading> */ /* design-system-escape: px-3 padding direcional sem Inset equiv.; py-1.5 padding direcional sem Inset equiv.; font-medium → className de <Text>/<Heading> */ "inline-flex items-center inline-snug px-3 py-1.5 rounded-full glass-kpi border border-info/25 bg-info/5 backdrop-blur-md text-caption font-medium text-info")}>
