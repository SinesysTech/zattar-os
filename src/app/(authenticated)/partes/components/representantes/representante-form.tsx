...
import { actionCriarRepresentante,
  actionAtualizarRepresentante } from '../../actions/representantes-actions';
import type { Representante,
  InscricaoOAB,
  TipoRepresentante,
  SituacaoOAB } from '../../types/representantes';
import { Dialog,
  DialogContent,
  DialogHeader,
  DialogTitle,
