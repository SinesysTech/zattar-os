...
import { actionCriarCliente,
  actionAtualizarClienteForm } from '../../actions';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className={cn(
          ...
          isEditMode ? "sm:max-w-3xl" : "sm:max-w-lg"
        )}
      >
        <DialogHeader className="px-6 py-4 border-b border-border/20 shrink-0">
          ...
          <DialogDescription className="sr-only">
            {isEditMode ? 'Formulário de edição de cliente' : stepInfo.description}
          </DialogDescription>
          {!isEditMode && (
