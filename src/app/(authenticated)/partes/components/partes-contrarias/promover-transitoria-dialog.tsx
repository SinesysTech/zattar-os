    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      {isLoading ? (
        ...
        <div className={cn("flex flex-col stack-default-plus")}>
          {transitoria && (
            <div className={cn("rounded-xl bg-surface-container-low/50 inset-medium ring-1 ring-outline-variant/30")}>
              <Text variant="caption" className="text-muted-foreground">
                Cadastro pendente
              </Text>
              <Text variant="label" weight="semibold" className={cn( "mt-0.5 text-foreground")}>
                {transitoria.nome}
              </Text>
                    ...
                    <li key={`${sug.kind}:${sug.id}`}>
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <Text variant="label" weight="medium" className={cn( "truncate text-foreground")}>
                            {sug.nome}
                          </Text>
                          <Text
