...
function RemoteCursorIndicator({ cursor }: RemoteCursorIndicatorProps) {
  ...
  return (
    <div
      className={cn(/* design-system-escape: gap-1 gap sem token DS; px-2 padding direcional sem Inset equiv.; py-1 padding direcional sem Inset equiv.; text-xs → migrar para <Text variant="caption">; font-medium → className de <Text>/<Heading> */ /* design-system-escape: gap-1 gap sem token DS; px-2 padding direcional sem Inset equiv.; py-1 padding direcional sem Inset equiv.; text-xs → migrar para <Text variant="caption">; font-medium → className de <Text>/<Heading> */ "absolute top-2 left-2 flex items-center gap-1 rounded-full px-2 py-1 text-xs font-medium text-white shadow-md animate-pulse")}
