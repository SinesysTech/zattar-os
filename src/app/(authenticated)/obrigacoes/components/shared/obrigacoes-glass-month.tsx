...
function ParcelaItem({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'w-full text-left rounded-lg inset-tight-plus border border-l-[3px] border-border/30 bg-muted/15',
          ...
          return (
            ...
            >
              ...
              {isSelected && popoverItems.length > 0 && (
                <PopoverContent
                  className={cn("w-96 inset-none ")}
                  align="center"
                  sideOffset={8}
                >
                  <div className={cn("flex items-center justify-between inset-medium border-b border-border/30")}>
                    ...
                    <button
                      ...
                      className={cn("inset-micro rounded-md hover:bg-muted/50 transition-colors")}
                      aria-label="Fechar"
                    >
                      <X className="w-3.5 h-3.5 text-muted-foreground" />
                    </button>
                  </div>
                  <div className={cn("flex flex-col max-h-96 overflow-y-auto inset-tight stack-tight")}>
