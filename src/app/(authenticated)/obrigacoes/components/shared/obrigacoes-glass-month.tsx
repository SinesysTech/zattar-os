...
function ParcelaItem({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        'w-full text-left rounded-lg p-2.5 border border-l-[3px] border-border/30 bg-muted/15',
  ...
  return (
    <GlassPanel depth={1} className="p-4 sm:p-6 flex flex-col">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex-1 flex justify-end gap-2 text-[11px] text-muted-foreground/60">
      ...
      <div className="grid grid-cols-7 gap-1.5 mb-1">
        {WEEKDAY_HEADERS.map((label, idx) => (
          <div
            key={label}
            className={cn(
              'text-center text-[11px] font-semibold text-foreground/45 py-2',
          ...
          return (
            ...
            >
              ...
              {isSelected && popoverItems.length > 0 && (
                <PopoverContent
                  className="w-96 p-0 glass-dialog"
                  align="center"
                  sideOffset={8}
                >
