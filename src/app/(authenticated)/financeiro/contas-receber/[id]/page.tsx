  ...
  if (!contaReceber) {
    return (
      <div className={cn("flex flex-col stack-default")}>
        ...
        <div className={cn("rounded-md bg-muted inset-extra-loose text-center")}>
                ...
                {contaReceber.anexos.map((anexo: { nome: string; url: string; tipo?: string; tamanho?: number }, index: number) => {
                  ...
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={cn("flex items-center inline-medium rounded-lg border inset-medium transition-colors hover:bg-muted/50")}
                    >
