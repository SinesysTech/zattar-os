  ...
  return (
    <div className={cn("flex flex-col stack-default-plus")}>
      ...
      <div className={cn("flex items-center inline-tight flex-wrap")}>
        ...
        <div className={cn("flex items-center inline-nano inset-nano rounded-lg bg-border/6")}>
          {VIEW_OPTIONS.map((opt) => (
            <button
              ...
              className={cn(
                'inset-snug rounded-md transition-all cursor-pointer',
                viewMode === opt.id
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                ...
                className={cn("inset-snug rounded-md text-muted-foreground/55 hover:text-muted-foreground transition-all cursor-pointer")}
              >
            ...
            <DropdownMenuContent
              align="end"
              className={cn("glass-dropdown rounded-2xl inset-snug min-w-44 border-border/40")}
            >
              <DropdownMenuItem
                asChild
