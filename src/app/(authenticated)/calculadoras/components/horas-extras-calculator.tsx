    ...
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-700 w-full pb-20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-surface-container-high/60 backdrop-blur-xl rounded-2xl p-8 border border-foreground/5 shadow-lg">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  className="w-full bg-surface-container-highest border border-foreground/5 rounded-lg p-4 text-on-surface focus:ring-1 focus:ring-primary/50 transition-all placeholder:text-outline" 
                />
              </div>
          ...
          <div className="bg-surface-container-low rounded-xl p-6 border border-foreground/5 flex gap-6 items-start">
        ...
        <div className="lg:col-span-5">
          <div className="bg-surface-container-lowest/40 backdrop-blur-[20px] border border-foreground/10 rounded-2xl overflow-hidden shadow-[0_40px_80px_rgba(0,0,0,0.6)]">
            ...
            <div className="p-8 bg-foreground/5 flex gap-4">
              <button className="flex-1 py-3 border border-foreground/10 rounded-lg text-sm font-bold text-on-surface hover:bg-foreground/5 transition-all">Exportar PDF</button>
              <button className="flex-1 py-3 border border-foreground/10 rounded-lg text-sm font-bold text-on-surface hover:bg-foreground/5 transition-all">Compartilhar Relatório</button>
            </div>
          </div>
        </div>
      </div>
