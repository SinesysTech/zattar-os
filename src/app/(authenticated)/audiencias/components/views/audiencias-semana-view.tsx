  ...
  return (
    <div className={cn("flex flex-col stack-default")}>
      ...
      <div className={cn("flex items-center inline-tight")}>
        <button onClick={handlePrevWeek} className={cn("inset-snug rounded-lg hover:bg-foreground/4 transition-colors text-muted-foreground/70 cursor-pointer")}>
        ...
        <button onClick={handleNextWeek} className={cn("inset-snug rounded-lg hover:bg-foreground/4 transition-colors text-muted-foreground/70 cursor-pointer")}>
