        ...
        <div className={cn("mb-3.5 grid grid-cols-2 gap-x-5 gap-y-2.5 border-b border-border/40 pb-3.5 sm:grid-cols-4")}>
          ...
          <div className={cn("flex flex-col inline-micro")}>
            ...
            >
              ...
              <PopoverContent className={cn("w-44 rounded-xl inset-snug glass-dropdown")} align="start">
                <Text
                  variant="overline"
                  as="p"
                ...
                {hasAta && (
                  <div>
                    ...
                    <button
                      ...
                      className={cn("flex w-full cursor-pointer items-center inline-medium rounded-xl border border-success/25 bg-success/8 inset-tight-plus text-left transition-colors hover:bg-success/12 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring")}
                    >
                  ...
                  <SectionCard>
                    ...
                    {isHibrida && (
                      <div className={cn("mt-3 pt-3 border-t border-border/40")}>
                        ...
                        <div className={cn("inline-flex inline-micro inset-micro rounded-lg bg-muted/60 border border-border/40")}>
                          {(
                            [
