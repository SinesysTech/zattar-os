...
## Contexto
Módulo administrativo do ZattarOS, focado em **observabilidade do banco de dados** e **gestão de infraestrutura**. Provê métricas de performance do Postgres (cache hit rate, queries lentas, bloat, índices não utilizados, disk I/O) e um assistente de decisão para upgrade de tier de compute do Supabase.
