...
interface ExpedienteResponsavelPopoverProps {
  expedienteId: number;
...
export function ExpedienteResponsavelPopover({
  expedienteId,
  responsavelId,
  usuarios,
  onSuccess,
  children,
  align = 'start',
}: ExpedienteResponsavelPopoverProps) {
  ...
  const handleSelect = React.useCallback(
    ...
    [expedienteId, responsavelId, onSuccess],
  );
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        className={cn(/* design-system-escape: p-0 → usar <Inset> */ "w-60 inset-none rounded-2xl glass-dropdown overflow-hidden")}
        align={align}
        side="bottom"
        onClick={(e) => e.stopPropagation()}
