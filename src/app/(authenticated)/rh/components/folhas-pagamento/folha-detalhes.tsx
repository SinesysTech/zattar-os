...
export function FolhaDetalhes({ folhaId }: FolhaDetalhesProps) {
  ...
  if (error || !folha) {
    return (
      <div className={cn("rounded-lg border border-destructive/50 bg-destructive/10 inset-dialog text-center text-destructive")}>
  ...
  return (
    <div className={cn("flex flex-col stack-loose")}>
      ...
      <Card>
        ...
        <CardContent className={cn("grid inline-default md:grid-cols-3")}>
          <div>
      ...
      {folha.itens.some((item) => item.lancamentoFinanceiroId) && (
        <Card className="border-primary/20 bg-primary/5">
          ...
          <CardContent>
                ...
                .map((item) => (
                  ...
                  >
                    <div className={cn("flex flex-col inline-micro")}>
                      ...
                      <div className={cn("flex items-center inline-default text-body-sm text-muted-foreground")}>
            ...
            <div className={cn("mt-4 rounded-md bg-muted/50 inset-medium text-body-sm text-muted-foreground")}>
