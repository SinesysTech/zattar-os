...
## Contexto
Modulo de cadastro auxiliar do ZattarOS para gerenciar os tipos de expedientes disponiveis no sistema. Funciona como tabela de dominio referenciada pelo modulo de expedientes. Utiliza cache Redis para otimizar leituras.
