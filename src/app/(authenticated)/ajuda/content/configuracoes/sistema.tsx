    ...
    <div className="space-y-10">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          ...
          demais parâmetros globais do sistema ZattarOS.
        </p>
      </div>
      ...
      <DocSection title="Integrações">
        <p className="text-muted-foreground mb-6">
          O ZattarOS se integra a serviços externos para ampliar suas funcionalidades. As
        ...
        <div className="space-y-3 mb-8">
          ...
          <DocFieldTable
            fields={[
              ...
              },
              {
                ...
                tipo: 'Número',
                obrigatorio: false,
                descricao: 'ID da inbox padrão para criação de conversas via ZattarOS.',
              },
              {
                campo: 'Habilitado',
                tipo: 'Booleano',
          ...
          />
          <DocTip>
            Após habilitar o Chatwoot, um ícone de chat aparece na barra lateral do ZattarOS,
      ...
      <DocSection title="Assistentes de Inteligência Artificial">
        <p className="text-muted-foreground mb-4">
          Configure os assistentes de IA disponíveis no ZattarOS para auxílio na análise de
      ...
      <DocSection title="Aparência e Tema">
        <p className="text-muted-foreground mb-4">
          Personalize a aparência visual do ZattarOS para toda a organização ou individualmente
          por usuário.
        </p>
        <DocActionList
          actions={[
