  ...
  return (
    <div className="space-y-10">
        ...
        <DocFieldTable
          fields={[
            ...
            },
            {
              ...
              tipo: 'Booleano',
              obrigatorio: false,
              descricao: 'Exibe a notificação na central de notificações do ZattarOS.',
            },
            {
              campo: 'Por E-mail',
              tipo: 'Booleano',
            ...
            },
            {
              ...
              tipo: 'Booleano',
              obrigatorio: false,
              descricao: 'Envia notificação push para o navegador, mesmo quando o ZattarOS não está aberto.',
            },
            {
      ...
      <DocSection title="Habilitando Notificações Push">
        ...
        />
        <DocTip>
          As notificações push funcionam mesmo com o ZattarOS minimizado ou em outra aba, desde
        ...
        <DocActionList
          actions={[
            ...
            },
            {
              ...
              descricao:
                'Ao acessar o ZattarOS pelo celular, as notificações são exibidas em formato responsivo na central.',
            },
            {
              icon: Settings,
