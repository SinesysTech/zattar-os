...
## Contexto
Módulo de notas pessoais do ZattarOS. Permite que cada usuário crie, edite, arquive e exclua notas com suporte a três tipos (texto, checklist, imagem) e organização por etiquetas coloridas. Dados são isolados por usuário via RLS.
