...
## Contexto
Modulo central de gestao de usuarios do ZattarOS. Gerencia cadastro, permissoes, cargos, sincronizacao com Supabase Auth e desativacao com desatribuicao automatica de itens. Utiliza cache Redis para otimizar leituras e sistema de permissoes granular por recurso/operacao.
