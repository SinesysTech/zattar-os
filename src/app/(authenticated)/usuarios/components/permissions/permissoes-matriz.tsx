...
export function PermissoesMatriz({
  ...
  if (isLoading) {
    return (
      <GlassPanel depth={1} className={cn("flex flex-col inset-default-plus stack-default")}>
  ...
  return (
    <>
      <GlassPanel depth={1} className={cn("flex flex-col inset-default-plus stack-default-plus")}>
        {/* Header */}
