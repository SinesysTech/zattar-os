...
export function EventItem({
    ...
    return (
      <EventWrapper
        ...
        className={cn(
          ...
          view === "week" ? /* design-system-escape: sm:text-xs sem equivalente DS */ "text-[10px] sm:text-xs" : "text-caption",
          className
        )}
        currentTime={currentTime}
        dndListeners={dndListeners}
  ...
  return (
    <button
      className={cn(
        /* design-system-escape: p-2 → usar <Inset> */ "focus-visible:border-ring focus-visible:ring-ring/50 flex w-full flex-col inline-micro rounded p-2 text-left transition outline-none focus-visible:ring-[3px] data-past-event:line-through data-past-event:opacity-90",
      ...
      <Text variant="caption" className="opacity-70">
        ...
        {event.location && (
          <>
            <span className={cn("px-1 opacity-35")}> · </span>
