  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="outline" size="sm" className="h-8 border-dashed bg-card">
          <PlusCircle />
          {title}
          {selectedValues?.size > 0 && (
            <>
              ...
              <div className={cn("flex hidden inline-micro lg:flex")}>
      ...
      <PopoverContent className={cn(/* design-system-escape: p-0 → usar <Inset> */ "w-[200px] bg-popover inset-none")} align="start">
        <Command>
