...
function ParteRow({ nome, subtitulo, papel, cpfCnpj }: ParteRowProps) {
  ...
  return (
    <div className={cn(/* design-system-escape: px-3 padding direcional sem Inset equiv.; py-2.5 padding direcional sem Inset equiv. */ "flex items-center inline-medium px-3 py-2.5 rounded-xl bg-muted/30 border border-border/40 transition-colors hover:bg-muted/50")}>
      <span
        aria-hidden="true"
