...
import { capturarArquivados } from '@/app/(authenticated)/captura/services/api-client';
...
export const ArquivadosForm = forwardRef<CapturaFormHandle, ArquivadosFormProps>(
  function ArquivadosForm({ onSuccess, onLoadingChange }, ref) {
