...
function LogStats({ logs }: { logs: LogEntry[] }) {
  ...
  return (
    <div className={cn("grid grid-cols-2 inline-tight sm:grid-cols-4")}>
      <div className={cn("flex items-center inline-tight-plus rounded-lg border bg-success/5 border-success/20 inset-tight-plus")}>
      ...
      <div className={cn("flex items-center inline-tight-plus rounded-lg border bg-info/5 border-info/20 inset-tight-plus")}>
      ...
      <div className={cn("flex items-center inline-tight-plus rounded-lg border bg-muted/40 inset-tight-plus")}>
      ...
      <div className={cn("flex items-center inline-tight-plus rounded-lg border bg-destructive/5 border-destructive/20 inset-tight-plus")}>
      ...
      {stats.conflitos > 0 && (
        <div className={cn("flex items-center inline-tight-plus rounded-lg border bg-warning/5 border-warning/20 inset-tight-plus col-span-2 sm:col-span-4")}>
        ...
        <div>
          ...
          <div className={cn("flex flex-col stack-snug")}>
            {erros.map((log, i) => (
              <div
                key={i}
                className={cn("flex items-start inline-tight rounded-lg border border-destructive/30 bg-destructive/6 inset-tight-plus")}
              >
...
export function CapturaRawLogs({ rawLogs }: CapturaRawLogsProps) {
  if (rawLogs.length === 0) {
    return (
      <div className={cn("flex flex-col items-center justify-center inline-tight rounded-lg border border-dashed inset-extra-loose text-center")}>
            ...
            >
              ...
              <AccordionContent>
                <div className={cn("flex flex-col stack-medium pb-3")}>
                  ...
                  {rawLog.erro && (
                    <div className={cn("flex items-start inline-tight rounded-lg border border-destructive/30 bg-destructive/6 inset-medium")}>
                      <XCircle className="h-3.5 w-3.5 text-destructive shrink-0 mt-0.5" />
