...
export function CapturaEscopoBadge({
  ...
  return (
    ...
    <Tooltip>
      ...
      <TooltipContent side="top" align="start" className={cn("max-w-xs inset-none overflow-hidden")}>
        ...
        <ul className={cn("px-3 py-2 grid grid-cols-2 gap-x-3 gap-y-1 max-h-56 overflow-y-auto")}>
          {detalhes.map((d, idx) => (
