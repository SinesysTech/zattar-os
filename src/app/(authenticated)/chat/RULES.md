...
## Contexto
Modulo de comunicacao interna do ZattarOS responsavel por salas de chat (texto, midia), chamadas de audio/video (via Dyte) com transcricao e gravacao, e historico de conversas. Integra-se com Supabase Realtime para mensagens em tempo real e com IA para geracao de resumos de chamadas.
