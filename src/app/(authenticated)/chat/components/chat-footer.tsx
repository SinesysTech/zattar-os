...
export function ChatFooter({ salaId, onEnviarMensagem, onTyping, typingIndicatorText }: ChatFooterProps) {
  ...
  return (
    <div className={cn("px-5 pb-4 pt-3 bg-chat-thread")}>
      ...
      {/* File Preview Area */}
      {uploadedFile && (
        <div className={cn("mb-2 inset-tight bg-muted rounded-md flex items-center justify-between")}>
                ...
                <div className="block lg:hidden">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button variant="ghost" className={cn("size-11 rounded-full inset-none")}>
