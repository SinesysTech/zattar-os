  ...
  return (
    <MeetingErrorBoundary>
      <MeetingThemeProvider>
        <div className="relative w-full h-full bg-video-bg overflow-hidden flex flex-col font-sans text-video-text">
          ...
          <div className="flex-1 relative flex overflow-hidden">
            ...
            {(effectiveShowParticipants || showTranscript) && (
              <div className="hidden md:flex flex-col w-80 h-full border-l border-video-border bg-video-surface/50 backdrop-blur-sm relative z-20">
                {effectiveShowParticipants && !showTranscript && (
