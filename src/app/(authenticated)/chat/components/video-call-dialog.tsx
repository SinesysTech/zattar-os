...
export function VideoCallDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={cn(/* design-system-escape: p-0 → usar <Inset> */ "w-[calc(100vw-1rem)] sm:max-w-3xl md:max-w-5xl lg:max-w-7xl h-[calc(100dvh-4rem)] sm:h-[90vh] p-0 overflow-hidden bg-black border-none text-video-text relative")}>
        <VisuallyHidden>
        ...
        {error && (
          <div className={cn(/* design-system-escape: p-8 → usar <Inset> */ "flex flex-col items-center justify-center h-full inline-default p-8 text-center bg-video-surface")}>
            ...
            <div className={cn("flex inline-default mt-4")}>
