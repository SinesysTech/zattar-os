...
export function CallTranscriptViewer({ chamada }: CallTranscriptViewerProps) {
  ...
  if (!chamada.transcricao) {
    return (
      <div className={cn("flex flex-col items-center justify-center inset-extra-loose text-muted-foreground border border-dashed rounded-lg")}>
    ...
    <div className="flex flex-col h-full border rounded-lg overflow-hidden bg-background">
      <Tabs defaultValue={resumo ? "resumo" : "transcricao"} className="flex flex-col h-full">
        ...
        <div className="flex-1 overflow-hidden relative">
          <TabsContent value="resumo" className={cn("h-full m-0 inset-none")}>
          ...
          <TabsContent value="transcricao" className={cn("h-full m-0 inset-none")}>
             <div className="h-full flex flex-col">
              <div className={cn("flex items-center justify-between inset-tight border-b text-caption text-muted-foreground bg-muted/20 px-4")}>
