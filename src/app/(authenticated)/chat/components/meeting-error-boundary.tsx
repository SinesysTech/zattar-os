...
export class MeetingErrorBoundary extends Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex flex-col items-center justify-center h-full w-full bg-video-bg text-video-text p-6 text-center">
          ...
          <div className="flex gap-4">
            <Button
              ...
              className="bg-transparent border-video-text text-video-text hover:bg-video-text hover:text-black"
            >
              Recarregar Página
            </Button>
            <Button
