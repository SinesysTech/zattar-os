 ...
 *
 * @example
 * import { DashboardContent, useDashboard, actionObterDashboard } from '@/app/(dashboard)/dashboard';
 * import type { DashboardData, DashboardUsuarioData } from '@/app/(dashboard)/dashboard';
 */
