        ...
        <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 lg:grid-cols-12 gap-12 relative z-10 w-full">
          <div className="lg:col-span-7 flex flex-col justify-center">
            ...
            <div className="flex flex-wrap gap-4">
              <button className="bg-primary text-on-primary-fixed px-8 py-4 rounded-xl font-bold text-lg hover:bg-primary-container transition-all duration-300 active:scale-95 flex items-center gap-2 shadow-lg shadow-primary/20">
                Falar com Especialista
                <ArrowRight className="w-5 h-5" />
              </button>
              <button className="border border-outline-variant/30 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/5 transition-all duration-300">
                Ver Demonstração
              </button>
            </div>
          </div>
      ...
      <section className="py-24 bg-background relative z-10">
        <div className="max-w-7xl mx-auto px-8">
          <div className="mb-16">
            ...
            <h2 className="font-headline text-4xl md:text-5xl font-bold text-white tracking-tight">Soluções Principais</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Solution 1: Large Column */}
            <div className="md:col-span-2 group">
              <div className="h-full bg-surface-container rounded-3xl p-10 border border-white/5 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(204,151,255,0.1)] transition-all duration-500 flex flex-col justify-between overflow-hidden relative">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-3xl font-headline font-bold text-white mb-4">Auditoria Automatizada</h3>
            ...
            {/* Solution 2: Square */}
            <div className="group">
              <div className="h-full bg-surface-container rounded-3xl p-8 border border-white/5 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(204,151,255,0.1)] transition-all duration-500 flex flex-col">
                ...
                <h3 className="text-2xl font-headline font-bold text-white mb-4">Análise Preditiva de Riscos</h3>
            ...
            <div className="group">
              <div className="h-full bg-surface-container rounded-3xl p-8 border border-white/5 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(204,151,255,0.1)] transition-all duration-500 flex flex-col">
                ...
                <h3 className="text-2xl font-headline font-bold text-white mb-4">Protocolo Acelerado</h3>
                <p className="text-on-surface-variant leading-relaxed">
            ...
            <div className="md:col-span-2 group">
              <div className="h-full bg-surface-container rounded-3xl p-8 border border-white/5 hover:border-primary/30 hover:shadow-[0_0_30px_rgba(204,151,255,0.1)] transition-all duration-500 flex items-center gap-12">
                ...
                <div>
                  <h3 className="text-2xl font-headline font-bold text-white mb-3">Escudo Digital Compliance</h3>
                  ...
                  <button className="text-white font-semibold underline decoration-primary underline-offset-8 hover:text-primary transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="lg:w-1/2">
              ...
              <h2 className="font-headline text-4xl md:text-6xl font-extrabold text-white tracking-tighter mb-8 leading-[1.1]">
                Zattar Engine: <br />
              ...
              <div className="space-y-8">
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2">Processamento de Alta Velocidade</h4>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-white mb-2">Integração Universal</h4>
            ...
            <div className="lg:w-1/2 relative">
              <div className="relative w-full aspect-square flex items-center justify-center">
                ...
                <div className="w-64 h-64 bg-surface-variant/60 backdrop-blur-[20px] rounded-full border border-primary/20 flex flex-col items-center justify-center relative shadow-[0_0_80px_rgba(204,151,255,0.15)] group hover:scale-105 transition-transform duration-700">
                  <Sparkles className="w-24 h-24 text-primary opacity-80 group-hover:opacity-100 transition-opacity drop-shadow-[0_0_15px_rgba(204,151,255,0.8)]" />
                  {/* Floating Data Points */}
                  <div className="absolute -top-4 right-0 bg-surface-container-highest px-4 py-2 rounded-lg border border-primary/30 text-xs font-mono text-white shadow-xl">LATÊNCIA: 12ms</div>
                  <div className="absolute -bottom-8 left-0 bg-surface-container-highest px-4 py-2 rounded-lg border border-primary/30 text-xs font-mono text-white shadow-xl">UPTIME: 99.99%</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-linear-to-br from-primary/10 via-surface-container-high to-surface-container rounded-4xl p-12 md:p-20 text-center border border-primary/20 relative overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.6)]">
            ...
            <div className="relative z-10 w-full flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-6 w-full max-w-lg mx-auto">
                <button className="bg-primary text-on-primary-fixed px-10 py-5 rounded-xl font-bold text-lg hover:bg-primary-container transition-all active:scale-95 shadow-lg shadow-primary/20 w-full sm:w-auto text-center">
                  Falar com Especialista
                </button>
                <button className="bg-transparent text-white px-10 py-5 rounded-xl font-bold text-lg border border-outline-variant/50 hover:bg-white/5 hover:border-white/20 transition-all w-full sm:w-auto text-center">
                  Agendar Demo
                </button>
              </div>
            </div>
