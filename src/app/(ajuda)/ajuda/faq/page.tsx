...
const faqItems = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer: 'Sim, o ZattarOS é responsivo e funciona em tablets e smartphones. No entanto, para melhor experiência, recomendamos o uso em desktop ou notebook.',
      },
      {
    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-lg">
          Encontre respostas para as dúvidas mais comuns sobre o ZattarOS.
        </p>
      </div>
