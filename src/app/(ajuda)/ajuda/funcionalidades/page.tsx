    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-lg">
          Conheça as principais funcionalidades do ZattarOS e aprenda a utilizá-las de forma eficiente.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <p>
            O ZattarOS foi desenvolvido para automatizar e otimizar a gestão de processos
