    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground text-lg">
          Recursos de integração disponíveis para conectar o ZattarOS com outros sistemas e ferramentas.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none">
          <p>
            O ZattarOS oferece múltiplas formas de integração para atender diferentes
          ...
          <p>
            ...
            diretamente com o ZattarOS, executando consultas e operações através
