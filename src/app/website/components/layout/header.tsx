...
export function Header() {
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 w-[96%] max-w-360 rounded-full border border-outline-variant/20 bg-surface-container-highest/60 backdrop-blur-xl flex justify-between items-center px-5 sm:px-7 md:px-10 py-2.5 md:py-3 z-50 shadow-ambient">
      {/* Mobile menu trigger */}
      <Sheet>
