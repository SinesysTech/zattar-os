...
const Particles: React.FC<ParticlesProps> = ({
  ...
  // Use colors array if provided, otherwise fallback to single color
  ...
  }, [ease, staticity, vx, vy, clearContext, circleParams, drawCircle, remapValue]);
  ...
  }, [color, colors, animate, initCanvas]);
