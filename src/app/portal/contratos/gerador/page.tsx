    ...
    <PortalShell>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        <div className="col-span-12 xl:col-span-7 space-y-8">
          ...
          <section className="bg-surface-container/60 backdrop-blur-xl border border-white/5 rounded-2xl p-8 border-l-4 border-l-primary/50 shadow-lg">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              <button className="flex flex-col items-center justify-center p-4 rounded-xl bg-black/20 hover:bg-black/40 border border-white/5 hover:border-white/10 text-on-surface-variant hover:text-on-surface transition-all">
          ...
          <section className="bg-surface-container/60 backdrop-blur-xl border border-white/5 rounded-2xl p-8 shadow-lg">
            <h3 className="font-headline text-xl font-bold mb-6 flex items-center gap-3 text-white">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="col-span-2 sm:col-span-1">
                <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-2">Nome da Contratante/Cliente</label>
                <input 
                  className="w-full bg-black/40 border-none rounded-xl p-4 text-white placeholder:text-outline focus:ring-1 focus:ring-primary/50 transition-all outline-none" 
                  placeholder="Nome Completo da Pessoa Jurídica" 
                  type="text"
                />
              </div>
              <div className="col-span-2 sm:col-span-1">
                <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-2">Valor do Contrato (Opcional)</label>
                <div className="relative">
                  <span className="absolute left-4 top-1/2 -translate-y-1/2 text-primary font-bold">R$</span>
                  <input 
                    className="w-full bg-black/40 border-none rounded-xl p-4 pl-12 text-white placeholder:text-outline focus:ring-1 focus:ring-primary/50 transition-all outline-none" 
                    placeholder="0,00" 
                    type="number"
                  />
                </div>
              ...
              <div className="col-span-2 sm:col-span-1">
                <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-2">Duração (Meses)</label>
                <select className="w-full bg-black/40 border-none rounded-xl p-4 text-on-surface focus:ring-1 focus:ring-primary/50 transition-all outline-none appearance-none">
              ...
              <div className="col-span-2 sm:col-span-1">
                <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-2">Data de Início/Eficácia</label>
                <input 
              ...
              <div className="col-span-2">
                <label className="block text-xs font-bold text-on-surface-variant uppercase tracking-widest mb-2">Cláusulas ou Exigências Específicas</label>
                <textarea 
                  className="w-full bg-black/40 border-none rounded-xl p-4 text-white placeholder:text-outline focus:ring-1 focus:ring-primary/50 transition-all outline-none resize-none" 
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between bg-primary/5 p-6 rounded-2xl border border-primary/20 gap-6">
            <div className="flex items-center gap-4 w-full sm:w-auto">
              ...
              <div>
                ...
                <p className="text-[10px] text-on-surface-variant uppercase tracking-wider">Mapeamento dinâmico CLT/Código Civil.</p>
              </div>
            </div>
            <button className="w-full sm:w-auto bg-linear-to-r from-primary to-primary-dim text-white px-8 py-4 rounded-xl font-black uppercase tracking-widest hover:shadow-[0_10px_30px_rgba(204,151,255,0.3)] active:scale-95 transition-all text-xs">
              Sintetizar Minuta
            </button>
          </div>
        ...
        <div className="col-span-12 xl:col-span-5 relative">
          <div className="lg:sticky lg:top-24">
            <div className="flex items-center justify-between mb-4 px-2">
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-on-surface-variant">Visualização em Tempo Real</span>
              <div className="flex gap-2">
                <button className="p-2 rounded-lg bg-surface-container-high text-on-surface-variant hover:text-white border border-white/5 hover:border-white/10 transition-all">
            ...
            {/* Document Canvas */}
            <div className="bg-surface-container-highest rounded-2xl p-10 shadow-2xl relative overflow-hidden group min-h-175 border border-white/10">
              <div className="absolute inset-0 bg-linear-to-br from-white to-surface-container-highest z-0"></div>
              ...
              <div className="relative z-10 space-y-6 flex flex-col h-full text-black">
                <div className="flex justify-between items-start border-b border-black/10 pb-6">
                  <div>
                    ...
                    <p className="text-[10px] text-on-surface-variant font-bold uppercase tracking-widest">Ref: ZAT-2024-089-T</p>
                  </div>
                ...
                <div className="space-y-4">
                  <div className="p-3 bg-black/5 rounded-lg border-l-2 border-black">
                    <p className="text-[10px] text-on-surface-variant uppercase tracking-widest mb-1 font-bold">Parte A (Contratante)</p>
                  ...
                  <div className="p-3 bg-black/5 rounded-lg border-l-2 border-primary/60">
                    <p className="text-[10px] text-on-surface-variant uppercase tracking-widest mb-1 font-bold">Parte B (Empregado/Contratado)</p>
                ...
                <div className="grid grid-cols-2 gap-8 pt-12">
                  <div className="border-t border-black/30 pt-2 text-center">
                    <p className="text-[8px] uppercase font-bold text-on-surface-variant">Representante Legal (Zattar)</p>
                  </div>
                  <div className="border-t border-black/30 pt-2 text-center">
                    <p className="text-[8px] uppercase font-bold text-on-surface-variant">Assinatura do Contratado</p>
                  </div>
                </div>
              </div>
