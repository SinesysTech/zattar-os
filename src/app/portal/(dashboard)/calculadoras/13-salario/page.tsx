    ...
    <div className="flex justify-between items-center py-3 border-b border-border">
      ...
      <span
        className={[
          ...
          dimmed ? "text-muted-foreground/30" : negative ? "text-red-400" : "text-foreground",
        ].join(" ")}
      >
        {value}
      </span>
        ...
        <section className="lg:col-span-5">
          <Card>
            <CardContent className="p-6 space-y-8 relative overflow-hidden">
              ...
              {/* Info note */}
              <p className="text-xs text-muted-foreground/60 italic leading-relaxed border-t border-border pt-6 relative z-10">
        ...
        <section className="lg:col-span-7 lg:sticky lg:top-28 space-y-4">
          <Card>
            <CardContent className="p-6 relative overflow-hidden">
              ...
              <p className="text-[10px] text-muted-foreground/40 italic mt-4 leading-relaxed relative z-10">
          ...
          <div className="flex gap-3">
            <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-muted border border-border hover:border-border/80 text-foreground text-xs font-bold uppercase tracking-widest rounded-xl transition-all hover:bg-muted/80">
              <FileDown className="w-4 h-4" />
              Download PDF
            </button>
            <button className="flex-1 flex items-center justify-center gap-2 py-3 bg-primary text-primary-foreground text-xs font-bold uppercase tracking-widest rounded-xl transition-all hover:bg-primary/90 shadow-[0_4px_20px_rgba(204,151,255,0.2)] hover:shadow-[0_4px_20px_rgba(204,151,255,0.4)]">
