    ...
    <div className="flex justify-between items-center py-3 border-b border-border">
      ...
      <span
        className={[
          ...
          dimmed ? "text-muted-foreground/30" : "text-foreground",
        ].join(" ")}
      >
        {value}
      </span>
          ...
          <Card>
            <CardContent className="p-6 relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-6 relative z-10">
                ...
                <span className="text-[10px] font-bold tracking-widest text-muted-foreground/60 uppercase border border-border px-2 py-1 rounded">
