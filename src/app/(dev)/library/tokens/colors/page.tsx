  ...
  return (
    <div>
      <DemoPageHeader
        ...
        description="Tokens canônicos do design system ZattarOS. Definidos em globals.css com variantes light/dark automáticas. Use SEMPRE estes em vez de cores Tailwind cruas."
      />
