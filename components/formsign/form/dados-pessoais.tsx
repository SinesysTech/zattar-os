...
} from '@/lib/formsign/validations/dadosPessoais.schema';
...
import InputCEP, { type AddressData } from '@/components/formsign/inputs/input-cep';
...
import { formatCPF, parseCPF } from '@/lib/formsign/formatters/cpf';
import { formatData } from '@/lib/formsign/formatters/data';
import { formatTelefone, parseTelefone } from '@/lib/formsign/formatters/telefone';
import { parseCEP } from '@/lib/formsign/formatters/cep';
import { ESTADOS_CIVIS, GENEROS, ESTADOS_BRASILEIROS } from '@/lib/formsign/constants/estadosCivis';
import { NACIONALIDADES } from '@/lib/formsign/constants/nacionalidades';
...
import { mapClienteFormToCliente } from '@/types/formsign/cliente-adapter.types';
import {
  TEXT_LIMITS,
  validateBirthDate,
  ...
  validateEmail,
  validateTextLength,
} from '@/lib/formsign/validations/business.validations';
