...
export function ProcessoForm({ onCancel, onSubmit, defaultValues, isLoading }: ProcessoFormProps) {
  ...
  return (
    <PageShell 
        title="Novo Processo" 
        actions={<Button variant="outline" onClick={onCancel}>Cancelar</Button>}
    >
        <Form {...form}>
                    ...
                    <div>
                        ...
                        <FormField
                            ...
                            <FormItem>
                                ...
                                <FormControl>
                                <Input type="number" placeholder="R$ 0,00" {...field} onChange={e => field.onChange(e.target.valueAsNumber)} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                            )}
