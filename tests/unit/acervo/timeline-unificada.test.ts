 ...
 */
function criarItemBase(overrides: Partial<TimelineItemEnriquecido> = {}): TimelineItemEnriquecido {
  return {
    id: 1,
...
describe('deduplicarTimeline', () => {
  ...
  describe('cenário complexo', () => {
    it('deve processar corretamente mix de documentos e movimentos', () => {
      const items: TimelineItemUnificado[] = [
        ...
        criarItemUnificado({
          ...
          documento: true,
          grauOrigem: 'segundo_grau',
          backblaze: { fileId: '123', fileName: 'x', downloadUrl: 'x', uploadedAt: '2025-01-01' },
        }),
      ...
      const movDup = resultado.find((i) => i._dedupeHash === 'mov:2025-01-16:61:Duplicado');
    ...
    it('deve lidar com grande volume de itens', () => {
      ...
      const comSegundoGrau = primeiros500.filter((i) => i.grauOrigem === 'segundo_grau');
