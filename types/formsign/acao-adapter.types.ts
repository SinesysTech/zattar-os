/**
 * Adaptador de tipos para Acao (específico do domínio jurídico do Formsign).
 *
 * Estes tipos são necessários apenas para compatibilidade com templates existentes
 * do Formsign. O Sinesys não possui conceito de "Acao" nativo, pois é multi-domínio.
 *
...
/**
 * @deprecated - Específico do domínio jurídico do Formsign.
