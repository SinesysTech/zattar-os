...
> **Propósito deste documento**: Registrar quais módulos do ZattarOS são intencionalmente embrionários ou minimais, e **por quê**. Isto evita que desenvolvedores futuros (humanos ou IA) tentem "consertar" módulos cuja simplicidade é uma decisão arquitetural, não uma omissão.

## Princípio: YAGNI ≠ Abandono

YAGNI (*You Aren't Gonna Need It*) é o princípio de não construir abstrações até que a necessidade seja real. Aplicado a módulos do ZattarOS, isso significa:
