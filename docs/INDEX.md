# Documentação do Zattar OS (Sinesys)
...
| [`AGENTS.md`](./architecture/AGENTS.md)             | Diretrizes táticas e técnicas exclusivas para agentes virtuais que operam dentro do Sinesys. Detalha arquiteturas restritivas e injeção de Server Actions ao Model Context Protocol. |
