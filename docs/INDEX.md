# Documentação do ZattarOS (desenvolvido pela Synthropic)
...
| [`AGENTS.md`](./architecture/AGENTS.md)             | Diretrizes táticas e técnicas exclusivas para agentes virtuais que operam dentro do ZattarOS. Detalha arquiteturas restritivas e injeção de Server Actions ao Model Context Protocol. |
