...
Você precisa ter as seguintes permissões no recurso `assinatura_digital`:
...
2. Acesse qualquer página do módulo (ex: `/assinatura-digital/templates`)
...
1. Acesse `/assinatura-digital/segmentos`
...
1. Acessar `/assinatura-digital/templates`
...
1. Acessar `/assinatura-digital/formularios`
