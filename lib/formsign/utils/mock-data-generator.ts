 ...
 *
 * @module lib/formsign/utils/mock-data-generator
 */

import type { Template } from '@/types/formsign/template.types';
import type { ClienteBasico, SegmentoBasico, FormularioBasico } from '@/backend/formsign-signature/services/data.service';
