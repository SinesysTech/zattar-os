...
import { DadosGeracao, TipoVariavel } from '@/types/formsign/template.types';
import { formatCPF } from '@/lib/formsign/formatters/cpf';
import { formatCNPJ } from '@/lib/formsign/formatters/cnpj';
import { formatTelefone } from '@/lib/formsign/formatters/telefone';
import { formatCEP } from '@/lib/formsign/formatters/cep';
import { formatDataExtenso } from '@/lib/formsign/formatters/data';
