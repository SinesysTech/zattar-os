...
} from '@/types/formsign/form-schema.types';
import {
  VALIDATOR_REGISTRY,
...
import { validateCNPJ } from '@/lib/formsign/validators/cnpj.validator';
import { validateTelefone } from '@/lib/formsign/validators/telefone.validator';
import { TEXT_LIMITS } from '@/lib/formsign/validations/business.validations';
import { parseCPF, parseCNPJ, parseTelefone, parseCEP, parseData } from '@/lib/formsign/formatters';
