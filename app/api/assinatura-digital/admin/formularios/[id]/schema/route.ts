...
import { getFormulario, updateFormulario } from '@/backend/formsign-admin/services/formularios.service';
...
/**
 * GET /api/assinatura-digital/admin/formularios/[id]/schema - Obter schema do formulário
 */
export async function GET(
  request: NextRequest,
  { params }: { params: Promise<{ id: string }> }
) {
  const authResult = await requirePermission(request, 'formsign_admin', 'listar');
...
/**
 * PUT /api/assinatura-digital/admin/formularios/[id]/schema - Atualizar schema do formulário
 */
export async function PUT(
  request: NextRequest,
  { params }: { params: Promise<{ id: string }> }
) {
  const authResult = await requirePermission(request, 'formsign_admin', 'editar');
  if (authResult instanceof NextResponse) {
    return authResult;
  }
