...
export async function GET(
  ...
  try {
    ...
    console.error('Erro em GET /formsign-admin/templates/[id]:', error);
...
export async function PUT(
  ...
  try {
    ...
    console.error('Erro em PUT /formsign-admin/templates/[id]:', error);
    return NextResponse.json({ error: message }, { status: 500 });
  }
}
...
export async function DELETE(
  ...
  try {
    ...
    console.error('Erro em DELETE /formsign-admin/templates/[id]:', error);
    return NextResponse.json({ error: message }, { status: 500 });
  }
}
