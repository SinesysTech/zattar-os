# Formulários de Assinatura Digital
...
- `GET /api/assinatura-digital/formularios` - Listar formulários
- `POST /api/assinatura-digital/formularios` - Criar formulário
- `GET /api/assinatura-digital/formularios/[id]` - Obter formulário
- `PUT /api/assinatura-digital/formularios/[id]` - Atualizar formulário
- `DELETE /api/assinatura-digital/formularios/[id]` - Deletar formulário
- `GET /api/assinatura-digital/formularios/[id]/schema` - Obter schema
- `PUT /api/assinatura-digital/formularios/[id]/schema` - Atualizar schema
- `GET /api/assinatura-digital/segmentos` - Listar segmentos
- `GET /api/assinatura-digital/templates` - Listar templates
