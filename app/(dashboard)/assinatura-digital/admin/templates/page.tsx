...
import type { Template as FormsignTemplate } from '@/types/formsign/template.types';
import {
  formatFileSize,
...
function TemplateActions({
  ...
  const handleEdit = () => {
    router.push(`/assinatura-digital/admin/templates/${template.template_uuid}/edit`);
  };
...
export default function TemplatesPage() {
  ...
  const [selectedTemplate, setSelectedTemplate] = React.useState<FormsignTemplate | null>(null);
  ...
  // Handlers para ações
  const handleEdit = React.useCallback((template: FormsignTemplate) => {
    router.push(`/assinatura-digital/admin/templates/${template.template_uuid}/edit`);
  }, [router]);

  const handleDuplicate = React.useCallback((template: FormsignTemplate) => {
    setSelectedTemplate(template);
    setDuplicateOpen(true);
  }, []);

  const handleDelete = React.useCallback((template: FormsignTemplate) => {
