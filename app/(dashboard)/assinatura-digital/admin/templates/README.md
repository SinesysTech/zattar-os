...
- `GET /api/assinatura-digital/admin/templates` - Listar
- `POST /api/assinatura-digital/admin/templates` - Criar
- `GET /api/assinatura-digital/admin/templates/[id]` - Obter
- `PUT /api/assinatura-digital/admin/templates/[id]` - Atualizar
- `DELETE /api/assinatura-digital/admin/templates/[id]` - Deletar
