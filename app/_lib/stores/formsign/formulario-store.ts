...
import type { VisualizacaoPdfData, VisualizacaoMarkdownData } from '@/types/formsign/formulario.types';
import type { DynamicFormSchema } from '@/types/formsign/form-schema.types';
import type { Template, MetadadoSeguranca } from '@/types/formsign/template.types';

export interface DadosCPF {
  cpf: string;
  clienteExistente: boolean;
  clienteId?: number;
  dadosCliente?: ClienteFormsign;
}
