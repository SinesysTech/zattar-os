...
create or replace function public.refresh_acervo_unificado()
returns void
language plpgsql
security invoker
set search_path = ''
...
comment on function public.refresh_acervo_unificado is 'Atualiza a VIEW materializada acervo_unificado. Use CONCURRENTLY para evitar bloqueios durante o refresh.';
