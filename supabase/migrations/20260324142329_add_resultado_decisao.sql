-- Migration: Add resultado_decisao to expedientes

CREATE TYPE public.resultado_decisao_enum AS ENUM ('desfavoravel', 'parcialmente_favoravel', 'favoravel');

ALTER TABLE public.expedientes ADD COLUMN resultado_decisao public.resultado_decisao_enum;
