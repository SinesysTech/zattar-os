...
const capturaTools: ToolDefinition[] = [
  {
    ...
    handler: async (args: AcervoGeralInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
  ...
  },
  {
    ...
    handler: async (args: AudienciasInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
        const body = toSnakeCase(args);
  ...
  },
  {
    ...
    handler: async (args: PendentesInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
        const body = toSnakeCase(args);
  ...
  },
  {
    ...
    handler: async (args: TimelineInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
        const body = toSnakeCase(args);
  ...
  },
  {
    ...
    handler: async (args: CapturaPartesInlineInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
        const body = toSnakeCase(args);
  ...
  },
  {
    ...
    handler: async (args: StatusCapturaInlineInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
        const response = await client.get(`/api/captura/historico/${args.capture_id}`);
        if (response.success && response.data) {
          return formatToolResponse(response.data);
        } else {
  ...
  },
  {
    ...
    handler: async (args: HistoricoCapturasInlineInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
  ...
  },
  {
    ...
    handler: async (args: AguardarCapturaInlineInput, client: SinesysApiClient): Promise<ToolResponse> => {
      try {
        const result = await pollCapturaStatus(client, args.capture_id, {
