...
import { toSnakeCase, formatToolResponse, handleToolError, pollCapturaStatus } from './utils';

// Tipos auxiliares para validação
type CodigoTRT = 'TRT1' | 'TRT2' | 'TRT3' | 'TRT4' | 'TRT5' | 'TRT6' | 'TRT7' | 'TRT8' | 'TRT9' | 'TRT10' | 'TRT11' | 'TRT12' | 'TRT13' | 'TRT14' | 'TRT15' | 'TRT16' | 'TRT17' | 'TRT18' | 'TRT19' | 'TRT20' | 'TRT21' | 'TRT22' | 'TRT23' | 'TRT24';
type GrauTRT = 'primeiro_grau' | 'segundo_grau' | 'tribunal_superior';
...
const capturaTools: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputSchema: z.object({
      trt_codigo: z.enum(['TRT1', 'TRT2', 'TRT3', 'TRT4', 'TRT5', 'TRT6', 'TRT7', 'TRT8', 'TRT9', 'TRT10', 'TRT11', 'TRT12', 'TRT13', 'TRT14', 'TRT15', 'TRT16', 'TRT17', 'TRT18', 'TRT19', 'TRT20', 'TRT21', 'TRT22', 'TRT23', 'TRT24']),
