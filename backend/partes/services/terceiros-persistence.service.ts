...
export function converterParaTerceiro(data: Record<string, unknown>): Terceiro {
  ...
  const base = {
    ...
    dados_pje_completo: dados_anteriores,
  ...
  if (tipo_pessoa === 'pf') {
    return {
      ...
      cartao_nacional_saude: data.cartao_nacional_saude as string | null,
      certificado_militar: data.certificado_militar as string | null,
      numero_titulo_eleitor: data.numero_titulo_eleitor as string | null,
      zona_titulo_eleitor: data.zona_titulo_eleitor as string | null,
      secao_titulo_eleitor: data.secao_titulo_eleitor as string | null,
      tipo_sanguineo: data.tipo_sanguineo as string | null,
      raca_cor: data.raca_cor as string | null,
    ...
    return {
      ...
      inscricao_municipal: data.inscricao_municipal as string | null,
