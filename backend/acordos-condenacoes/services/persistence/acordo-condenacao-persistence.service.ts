...
function mapearAcordoCondenacao(data: AcordoCondenacaoDb): AcordoCondenacao {
  return {
    ...
    percentualEscritorio: data.percentual_escritorio ?? null,
    percentualCliente: data.percentual_cliente ?? null,
    honorariosSucumbenciaisTotal: data.honorarios_sucumbenciais_total || 0,
