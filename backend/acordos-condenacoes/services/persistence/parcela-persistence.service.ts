...
function mapearParcela(data: ParcelaDb): Parcela {
  return {
    ...
    honorariosSucumbenciais: parseFloat(data.honorarios_sucumbenciais || 0),
    honorariosContratuais: data.honorarios_contratuais ? parseFloat(data.honorarios_contratuais) : 0,
    ...
    valorRepasseCliente: data.valor_repasse_cliente ? parseFloat(data.valor_repasse_cliente) : null,
