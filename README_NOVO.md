...
| **[Estrutura de Diretórios](./docs/estrutura-diretorios.md)** | Organização de pastas e arquivos |
| **[Padrões de Código](./docs/padroes-codigo.md)** | Convenções, boas práticas e code style |
...
| **[Configuração de Permissões](./docs/configuracao-permissoes.md)** | Sistema de cargos e permissões |
| **[Deploy em Produção](./docs/deploy.md)** | Docker, CapRover, variáveis de ambiente |
| **[Sistema de Cache Redis](./docs/cache-redis.md)** | Configuração e estratégias de cache |
...
| Documento | Descrição |
|-----------|-----------|
| **[Componentes Reutilizáveis](./docs/componentes-reutilizaveis.md)** | shadcn/ui, patterns, design system |
| **[API e Documentação](./docs/api-documentacao.md)** | Endpoints REST, Server Actions, Swagger |
...
📖 Detalhes completos: [Stack Tecnológica](./docs/stack-tecnologica.md)
...
📖 **Detalhes completos**: [Licença e Marca Registrada](./docs/licenca.md)
