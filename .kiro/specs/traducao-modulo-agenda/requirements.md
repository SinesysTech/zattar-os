...
Realizar tradução completa do módulo de agenda (calendar) do inglês para o português brasileiro, mantendo a funcionalidade existente e aplicando ajustes de layout conforme os padrões do design system ZattarOS.
...
2. Manter consistência terminológica com outros módulos do ZattarOS
...
### US-2: Como usuário, quero que o layout da agenda siga os padrões do ZattarOS
**Critérios de Aceitação:**
