...
A solução envolve tradução sistemática de todos os textos do módulo de agenda para português brasileiro, mantendo a estrutura e funcionalidade existentes. Aplicaremos também ajustes de layout para conformidade com o design system ZattarOS.
...
- Design System ZattarOS: `.cursor/rules/design-system-protocols.mdc`
